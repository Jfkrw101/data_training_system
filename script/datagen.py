...
parser.add_argument("--number_img",type=int, default=100,help="Number of Dataset want to Gen")
...
obj_dict = {
    1: {'folder': 'humans', 'longest_min': 40, 'longest_max': 300}
...
generate_dataset(args.number_img,dataset_dir,args.dataset_name)